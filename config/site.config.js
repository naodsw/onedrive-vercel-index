...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'nao@altaf.xyz',

  // [OPTIONAL] This is the website icon to the left of the title inside the navigation bar. It should be placed under the
  // /public directory of your GitHub project (not your OneDrive folder!), and referenced here by its relative path to /public.
  icon: '/icons/dynamic.ico',
  ...
  protectedRoutes: ['/Personal/Private'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:nao@altaf.xyz',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/naodsw',
    },
    {
      name: 'Telegram',
      link: 'https://t.me/naodsw',
    },
  ],
